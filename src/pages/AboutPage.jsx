...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className="w-full bg-navy">
      ...
      {/* About Section 1 */}
      <section className="about-section py-20 px-4 bg-slate relative overflow-visible min-h-max">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-2 gap-4 auto-rows-max">
              {about.values && about.values.map((value, idx) => (
                <div
                  key={idx}
                  className="p-6 rounded-xl bg-gradient-to-br from-indigo-900/30 to-violet-900/30 border border-indigo-500/30 hover:border-indigo-400/60 transition-all duration-300 min-h-fit"
                >
      ...
      {/* Vision & Mission */}
      <section className="about-section py-20 px-4 bg-navy relative overflow-visible min-h-max">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 auto-rows-max">
            {/* Vision */}
            <div className="p-8 rounded-2xl bg-gradient-to-br from-indigo-900/30 to-violet-900/30 border border-indigo-500/30 min-h-fit">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 auto-rows-max">
            {about.values && about.values.map((value, idx) => (
              <div
                key={idx}
                className="p-8 rounded-2xl bg-gradient-to-br from-indigo-900/20 to-violet-900/20 border border-indigo-500/30 hover:border-indigo-400/60 transition-all duration-300 hover-lift min-h-fit"
              >
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 bg-gradient-to-b from-navy via-slate to-navy relative overflow-visible min-h-max">

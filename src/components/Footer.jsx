    ...
    <footer className="bg-white border-t border-gray-200 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="text-primary font-bold mb-4">ITSA</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-primary font-bold mb-4">Contact</h3>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <Mail size={16} className="text-secondary" />
                <a href="mailto:itsa@ghrcem.ac.in" className="text-textSecondary hover:text-primary text-sm transition-colors">
                  itsa@ghrcem.ac.in
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Phone size={16} className="text-secondary" />
                <a href="tel:+919999999999" className="text-textSecondary hover:text-primary text-sm transition-colors">
                  +91 9999999999
                </a>
              </div>
              <div className="flex items-center gap-3">
              ...
              {[
                ...
                return (
                  <a
                    key={idx}
                    href={social.href}
                    className="w-10 h-10 rounded-lg bg-primary/10 hover:bg-primary/20 flex items-center justify-center text-primary hover:text-primary transition-all duration-300 shadow-primary"
                  >
                    <Icon size={18} />
                  </a>
                );
